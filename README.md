...
Data represented as QuickBits provides the model with information directly correlated to the Hash without actually performing the Hashing function.
This is extremely important since the Hash function is not differentiable and cannot be backpropagated through.
